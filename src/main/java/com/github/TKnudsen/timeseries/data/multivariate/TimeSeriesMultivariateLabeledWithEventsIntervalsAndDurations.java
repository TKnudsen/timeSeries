...
//	}
	...
	private TimeSeriesMultivariateLabeledWithEventsIntervalsAndDurations() {
		super();
	}
	
	public TimeSeriesMultivariateLabeledWithEventsIntervalsAndDurations(List<ITimeSeriesUnivariate> timeSeriesUnivariateList, List<String> timeSeriesNames) {
		super(timeSeriesUnivariateList, timeSeriesNames);
	}

	public TimeSeriesMultivariateLabeledWithEventsIntervalsAndDurations(long id, List<ITimeSeriesUnivariate> timeSeriesUnivariateList, List<String> timeSeriesNames) {
		super(id, timeSeriesUnivariateList, timeSeriesNames);
	}

	public TimeSeriesMultivariateLabeledWithEventsIntervalsAndDurations(ITimeSeriesMultivariate tsm) {
