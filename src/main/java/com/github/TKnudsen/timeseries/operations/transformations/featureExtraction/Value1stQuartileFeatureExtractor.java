...
/**
 * <p>
 * Title: Value1stQuartileFeatureExtractor
 * </p>
 * 
 * <p>
 * Description:
 ...
 * @version 1.01
 */
public class Value1stQuartileFeatureExtractor implements IFeatureExtractor<ITimeSeriesUnivariate, NumericalFeature> {
	...
	public List<NumericalFeature> transform(ITimeSeriesUnivariate input) {
		...
		res.add(new NumericalFeature("1stQuartile", apply(input)));
		return res;
	}
